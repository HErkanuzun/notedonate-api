...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('notes', function (Blueprint $table) {
            ...
            $table->string('file_path')->default('https://images.unsplash.com/photo-1733077151496-5e2701fc64eb?q=80&w=2574&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')->nullable();
